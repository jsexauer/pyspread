...
# Copyright Alex Flint, Jason Sexauer, Martin Manns
# Distributed under the terms of the GNU General Public License
# Process Isolation toolbox distributed under Apache License
...
Modified by Jason Sexauer for PySpread to fit inside of currently developed
remote process framework.  Mostly used to create proxy objects of variables
that exist in the host process which need to accessed by the child process

Based off of work of Alex Flint's process_isolation module
